...
import com.example.mapas.databinding.FragmentLocalizacionBinding
import com.example.mapas.databinding.FragmentMarcadorBinding
...
class Localizacion : Fragment() {
    ...
    override fun onCreateView(
        ...
        val frag = FragmentLocalizacionBinding.inflate(inflater, container, false)
        binding = frag
        mapView = frag.mapView
